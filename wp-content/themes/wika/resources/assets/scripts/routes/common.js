...
import { faBackspace, faCircleNotch, faSpinner, faSync, faArrowLeft, faArrowRight, faExclamationTriangle, faSearch, faQuestion, faSignInAlt, faSignOutAlt, faHome, faAngleDown } from '@fortawesome/free-solid-svg-icons';
...
export default {
  init() {
    ...
    library.add( faBackspace, faCircleNotch, faSpinner, faSync, faArrowLeft, faArrowRight, faExclamationTriangle, faSearch, faQuestion, faSignInAlt, faSignOutAlt, faHome, faAngleDown );
    ...
    function mediaSize() { 
      ...
      if (window.matchMedia('(min-width: 768px)').matches) {
        if( wp.is_home === "1" ){
          ...
          if (wp.has_admin_bar === "1") {
            bannerHeight = banner.outerHeight() + 16;
          }else{
            bannerHeight = banner.outerHeight() - 15;
          }
        }
