...
$instance_qcsldpremium = new QcSupportAndPromoPage('qcld-sld-pro-support');

if( is_admin() )
{
	$instance_qcsldpremium->plugin_menu_slug = "edit.php?post_type=sld"; //Edit Value
	$instance_qcsldpremium->plugin_name = "SLD - Premium Version"; //Edit Value
	$instance_qcsldpremium->show_promo_page();
}
