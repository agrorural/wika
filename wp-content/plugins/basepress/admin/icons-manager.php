...
if( ! class_exists( 'basepress_icons_manager' ) ){
	...
	class basepress_icons_manager{
		...
		public function add_icons_page(){
			...
			add_submenu_page( 'basepress', 'BasePress ' . __( 'Icons Manager', 'basepress' ), __( 'Icons Manager', 'basepress' ), 'manage_options', 'icons-manager', array( $this, 'display_screen' ) );
		...
		public function enqueue_admin_scripts( $hook ){
			if( 'basepress_page_icons-manager' == $hook ){
				wp_register_script( 'basepress-icons-menager', plugins_url( 'js/basepress-icons-manager.js', __FILE__ ), array( 'jquery' ));
				wp_enqueue_script( 'basepress-icons-menager' );
					...
					<form id="icons-manager-data">
						...
						<div class="basepress-card">
							...
							<select id="icons-context">
								...
								<option value="postmeta"><?php echo __( 'Post Meta Icons', 'basepress' ); ?></option>
							</select>
							...
							<input type="button" id="restore-default-icons" value="<?php echo __( 'Restore Defualt Icons', 'basepress' ); ?>" class="button action">
