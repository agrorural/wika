...
if ( ! class_exists( 'Basepress_Section_Metabox' ) ) {
	...
	class Basepress_Section_Metabox {
		...
		public function render_meta_box( $post ) {
			...
			$menu_order = 'add' == $screen->action ? -1 : $post->menu_order;
			...
			<input name="menu_order" id="basepress_menu_order" value="<?php echo $menu_order; ?>" data-term="<?php echo $value; ?>" data-order="<?php echo $menu_order; ?>" hidden>
			<?php
		}
