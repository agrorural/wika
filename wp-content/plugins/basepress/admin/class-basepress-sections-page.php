...
if ( ! class_exists( 'Basepress_Sections_Page' ) ) {
	...
	class Basepress_Sections_Page {
		...
		public function add_sections_page() {
			...
			add_submenu_page( 'edit.php?post_type=knowledgebase', 'BasePress ' . __( 'Sections', 'basepress' ), __( 'Sections', 'basepress' ), 'manage_categories', 'sections', array( $this, 'display_screen' ) );
		...
		public function enqueue_admin_scripts( $hook ) {
			...
			if ( 'knowledgebase_page_sections' == $hook ) {
				wp_enqueue_media();
								...
								<div class="table-nav top">
									<div class="alignleft">
										...
										<select id="product-select" class="alignleft">
											<option value="0" selected="selected" disabled="disabled"><?php echo __( 'Select Product', 'basepress' ); ?></option>
