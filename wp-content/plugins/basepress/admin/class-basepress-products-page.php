...
if ( ! class_exists( 'Basepress_Products_Page' ) ) {
	...
	class Basepress_Products_Page {
		...
		public function add_products_page() {
			...
			add_submenu_page( 'edit.php?post_type=knowledgebase', 'BasePress' . __( 'Products', 'basepress' ), __( 'Products', 'basepress' ), 'manage_categories', 'products', array( $this, 'display_screen' ) );
		...
		public function enqueue_admin_scripts( $hook ) {
			...
			if ( 'knowledgebase_page_products' == $hook ) {
				wp_enqueue_media();
		...
		public function display_screen() {
			?>
			<div class="wrap">
				<h1><?php echo __( 'Knowledge Base Products', 'basepress' ); ?></h1>
				...
				<div id="col-container" class="wp-clearfix">
					...
					<div id="col-left">
						<div class="col-wrap">
							<div class="form-wrap">
								<h2><?php echo __( 'Add New Product', 'basepress' ); ?></h2>
								...
								<form id="new-basepress-product">
									...
									<div class="form-field form-required term-name-wrap">
										...
										<p class="description"><?php echo __( 'The name is how it appears on your site.' ); ?></p>
									</div>
									
									<div class="form-field term-slug-wrap">
										<label for="product-slug">Slug</label>
										<input name="slug" id="product-slug" type="text" value="" size="40">
										<p class="description"><?php echo __( 'The &#8220;slug&#8221; is the URL-friendly version of the name. It is usually all lowercase and contains only letters, numbers, and hyphens.' ); ?></p>
									</div>
									...
									<div class="form-field term-description-wrap">
										...
										<p class="description"><?php echo __( 'The description is not prominent by default; however, some themes may show it.' ); ?></p>
									</div>
									
									<div class="form-field term-image-wrap">
										<label for="product-image-url"><?php echo __( 'Product image', 'basepress' ); ?></label>
										...
										<p class="description"><?php echo __( 'Choose an image for this product.', 'basepress' ); ?></p>
									...
									<p class="submit">
										...
										<?php echo __( 'Add New Product', 'basepress' ); ?>
										</a>
									</p>
								</form>
							</div>
			...
			<div id="edit-product-wrap">
				<form id="edit-basepress-product">
					...
					<h2>
						<?php echo __( 'Edit Product', 'basepress' ); ?>
					...
					<div class="form-field term-image-wrap">
						<label for="product-image-url-edit"><?php echo __( 'Product image', 'basepress' ); ?></label>
		...
		public function basepress_delete_product() {
			...
			if ( is_wp_error( $term ) || null == $term ) {
				echo 'The Product cannot be deleted';
				wp_die();
			}

			//If the term has some articles exit
			if ( $term->count > 0 ) {
				echo 'This product has some articles. You must delete the articles first.';
				wp_die();
			} else {
