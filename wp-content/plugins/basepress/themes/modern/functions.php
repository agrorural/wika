...
if ( ! function_exists( 'basepress_modern_theme' ) ) {
	...
	class basepress_modern_theme {
		...
		public function enqueue_scripts() {
			...
			{
				wp_enqueue_script( 'stickyfixed-js', plugins_url( 'js/fixedsticky.js', __FILE__ ), array( 'jquery' ), false, true );
				wp_enqueue_script( 'basepress-modern-js', plugins_url( 'js/modern.js', __FILE__ ), array( 'stickyfixed-js' ), false, true );
