...
class Basepress_Sections_Widget extends WP_Widget {
	...
	public function form( $instance ) {
		...
		<label for="<?php echo esc_attr( $this->get_field_id( 'post-count' ) ); ?>"><?php esc_attr_e( 'Display posts count', 'basepress' ); ?></label>
		</p>
		<?php
	}
	...
	public function update( $new_instance, $old_instance ) {
		...
		$instance['post-count'] = ( ! empty( $new_instance['post-count'] ) ) ? strip_tags( $new_instance['post-count'] ) : 0;
