<?php
/**
 * This is the class that creates and handles the products widget
 */
...
class Basepress_Products_Widget extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			...
			esc_html__( 'knowledge Base - Products', 'basepress' ), // Name
			array( 'description' => esc_html__( 'Lists all the products in the Knowledge Base', 'basepress' ) )
		);
	...
	private function get_products_list( $instance ) {
		...
		foreach ( $products as $product ) {
			...
			echo '<li class="bpress-widget-item product' . $active . '">';
	...
	private function get_products_dropdown( $instance ) {
		...
		echo '<option value="" disabled selected>' . __( 'Select Product', 'basepress' ) . '</option>';
